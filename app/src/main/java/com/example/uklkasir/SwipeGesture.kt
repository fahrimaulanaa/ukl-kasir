...
abstract class SwipeGesture(context: Context): ItemTouchHelper.SimpleCallback(
    ...
    private val edtColor = ContextCompat.getColor(context, R.color.blue)
    private val edtIcon = R.drawable.ic_edit
    override fun onMove(
    ...
    override fun onChildDraw(
        ...
        RecyclerViewSwipeDecorator.Builder(
            ...
            .addSwipeRightBackgroundColor(edtColor).addSwipeRightActionIcon(edtIcon)
            .create().decorate()
